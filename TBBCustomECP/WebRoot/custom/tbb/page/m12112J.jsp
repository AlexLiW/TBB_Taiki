			...
			<table class="table">
				<tr>
					<td colspan="4" valign="top" class="clear">
							<span class="top" ><img src="custom/tbb/image/logo.jpg"  alt=""/>臺灣企銀</span>
					</td>
				</tr>
				...
				<tr >
					...
					<span class="top" >臺灣中小企業銀行轉介客戶抱怨單</span>
					</div>
					</td>
				</tr>
				...
				<tr>
					...
					<div>
							<table  style="font-size:18px;">
								<tr>
								<td colspan="4">聯絡人姓名：<input type="text" disabled size="8" id="Name" onclick="return false"/>
									身份證字號/統編：<input type="text" disabled size="10" id="IdCard" onclick="return false"/>					
								...
								<tr>
								 ...
								 公司電話：<input type="text" disabled id="CorPhone" onclick="return false" size="18"/>
									手機：<input type="text" disabled id="Cellphone" onclick="return false" size="16"/></td>
								</tr>
								...
								<tr>
									<td colspan="4">內容說明：(1000字以內)<textarea id="Content" disabled style="height:200px;"></textarea></td>
								</tr> 
								<tr>
								<td colspan="4">
								處理人員：<input type="text" disabled id="CustomSerId" onclick="return false" size="20"/>    
								客服主管簽章：<input type="text"   size="15"/>
								處理部門：<input type="text" disabled id="SollveId" onclick="return false"  size="6"/></td>
								
							</tr>
								<tr><td colspan="4"><hr/><span><strong>客訴中心處理資訊</strong></span></td></tr>
								
														
								<tr>
									<td colspan="4">案件等級：
									<input type="radio" name="Rank" onclick="return false"/> A級
									<input type="radio" name="Rank" onclick="return false"/> B級 
									<input type="radio" name="Rank" onclick="return false"/> C級 
									<input type="radio" name="Rank" onclick="return false"/> D級 
									</td>
								</tr>
								...
								<tr>
									...
									<td id="td">
										<input type="checkbox" name="Type" onclick="return false"/>業務管理部</td>
								</tr>
								...
								<tr><td colspan="4"><hr/></td></tr>
								<tr>
									<td colspan="4">客訴中心處理結果：（1000字以內）<textarea id="Result" class="text" disabled style="height:200Px;"></textarea></td>
								</tr>
								
							
								
								<tr>									
								<td>經辦：<input type="text" disabled  size="8"/> </td>   
								<td>襄理：<input type="text" disabled  size="8"/></td>								
								<td>副主管：<input type="text" disabled  size="8"/></td>
								<td>主管：<input type="text" disabled  size="8"/></td>
                                                                      
								</tr>
<tr><td colspan="3">業務管理部傳真(02)2550-8338或(02)2550-9839</td></tr>
								</table>
						</div>
					</td>
				</tr>
