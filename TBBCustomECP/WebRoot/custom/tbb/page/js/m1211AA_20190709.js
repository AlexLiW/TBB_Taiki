	...
	var m1211AA ={
		...
		doDeal: function()
		{
			...
			var F_Customer      = CommonBusiness.getFieldValue('Qs.User',FUserId,'FName');
		...
		doOpen : function()
		{
			...
			var FUserId   		   = form.getFieldText("FUserId");//客服人员
			var F_DepartmentId   	= form.getFieldText("F_DepartmentId");//处理部门	
