var m12111A ={
		...
		doDeal: function()
		{
			...
			var F_WTime   	    = form.getFieldValue("F_WTime");//预计完成时间	
	...
	setF_WayRequire : function()
	{
		...
		{ 
			...
			var F_FenHang  			= form.getFieldText("F_FenHang");//分行名称
			...
			Utility.openDialog("TBB.m12111A.Report.page",args);
		},
