						...
						<table style="font-size: 18px;">
							...
							<tr>
							 ...
							 <tr>
								<td colspan="4">
									掛失種類：
									<input type="checkbox" name="DebitCardTerminal" onclick="return false" class="checkbox" />
									金融卡
									<input type="checkbox" name="DebitCardTerminal" onclick="return false" class="checkbox" />
									存摺
									<input type="checkbox" name="DebitCardTerminal" onclick="return false" class="checkbox" />
							...
							<tr>
								<td colspan="4">
									金融卡類別：
									<input type="radio" name="LossCardType" onclick="return false" class="radio" />
									COMBO
									<input type="radio" name="LossCardType" onclick="return false" class="radio" />
									晶片金融卡
									<input type="radio" name="LossCardType" onclick="return false" class="radio" />
							...
							<tr>
							<td colspan="4">  
							經辦：<input type="text" size="50" id="FUserId" onclick="return false" />  
