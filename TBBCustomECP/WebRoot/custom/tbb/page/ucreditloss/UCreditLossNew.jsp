    ...
    <c:body>
        <div align="center" id="tbb">
            <table class="table" width="100%">
                ...
                <tr>
                    <td colspan="4" valign="top">
                      ...
                      <td colspan="4">
                                ...
                                <tr>
                                    <td colspan="4"><input type="radio" name="SupplyCard" onclick="return false" class="radio" />
                                        掛失不主動補卡，請持卡人攜帶身分證、原留印鑑至分行辦理［適用VD卡、MD卡］</td>
                                </tr>
                                <tr>
                                    <td colspan="4"><input type="radio" name="SupplyCard" onclick="return false" class="radio" />
                                        掛失不主動補卡，請持卡人攜帶身分證、原留印鑑至原歸屬行辦理［適用COMBO卡］</td>
                                </tr>
                                <tr>
                                    <td id="SupplyCardOther1" colspan="3">
                                        <input type="radio" name="SupplyCard" onclick="return false" class="radio" />
                                        其他：<input type="text" id="SupplyCardOther" onclick="return false" /></td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <hr />
                ...
                <tr>
                    <td colspan="3"><input type="radio" name="null" onclick="return false" class="radio" />
                        此為VISA金融卡/悠遊DEBIT卡請分行逕行鍵機補發執行107-41及115-01</td>
                </tr>
                <tr>
                    <td colspan="3"><input type="radio" name="null" onclick="return false" class="radio" />
                        1本表為客戶電話掛失紀錄。<br>
                        <input type="checkbox" name="null" value="checkbox" disabled="disabled" />
                        <font color="red">COMBO卡/VISA金融卡/悠遊DEBIT卡如“掛失不補卡”僅執行107-41即可。</font>
                    </td>
                </tr>
                <tr>
                    <td colspan="3"><input type="radio" name="null" onclick="return false" class="radio" />
                ...
                <tr>
                    <td colspan="3"><input type="radio" name="null" onclick="return false" class="radio" />
                        3若有非本人交易時，請要求客戶，於受通知日起七日內向當地警察機關報案。此致________分行</td>
                </tr>
                </tr>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">客服中心經辦 ：<input type="text" size="15" id="FUserId" onclick="return false" /></td>
                    <td colspan="2">
                        覆核
                        <input type="text" size="20" id="null" onclick="return false" />
                        主管<input type="text" size="5" id="null" onclick="return false" /></td>
                </tr>
                <tr>
                    <td colspan="4">
                        <hr />
                ...
                <tr>
                    <td colspan="4"><input type="text" size="75" /></td>
                </tr>
            </table>
        </div>
        </td>
